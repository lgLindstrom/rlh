...
import 'package:rlh_flutter/business/use_cases/register_user.dart';
...
class RegisterPageController {
  ...
  Future<UiUpdate> verifyEmail(String email, String code, String passwd) async {
    ...
    var result = await verify.verifyEmail(email: email, code: code, passwd:passwd);

    if (result is BaasAccessSuccess) {return UiUpdateSuccess('Logged in');};

    return UiUpdateMessage('No success');
  }

  final Register _onboarding = GetIt.instance.get<Register>();
}
